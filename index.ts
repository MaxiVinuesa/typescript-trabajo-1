...
let i: number=0;
let dia, mes, anio: number = 0;
let control,control1, bandera: number = 0;
let contador: any;

let pendiente: string = "❗ Pendiente";
let enCurso: string = "🛠 En curso";
let terminada: string = "✔ Terminada";
let unaEstrella: string = "⭐";
let dosEstrellas: string = "⭐⭐";
let tresEstrellas: string = "⭐⭐⭐";

function tarea(id:number, titulo:string, descripcion:string, dificultad:any, creacion:Date, vencimiento:any, estado:string): object {
...
function tareaEspecifica(): number{
...
function tareaDetallada(identificador:number): void{
    i = identificador;
    console.log("-----------------------------------");
...
function modificarTarea(opc:number, identificador:number): void{
...
function seguirModificando(): void{
    console.log("-----------------------------------");
...
function mostrarTareasPendientes(): number{
...
function mostrarTareasEnCurso(): number{
    let contador:number = 0;
...
function mostrarTareasTerminadas(): number{
    let contador:number = 0;
...
function verificadorModificador(): number{
...
function controlarDia(dia: number): number{
    while ( (dia < 1) || (dia > 31)){
...
function controlarMes(mes: number): number{
    while ( (mes < 1) || (mes > 12) ){
...
function controlarAnio(anio: number): number{
    while ( (anio < 2024)) {
...
function controlarFecha(vencimiento: any): any{
...
function TraducirDificultad(dificultad: string){
